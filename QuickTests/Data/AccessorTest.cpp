...
public:
    ...
    Engine::Data::Accessor<TestType> A;
    Engine::Data::Accessor<TestType, false, true> B;
    Engine::Data::Accessor<TestType, true, false> C;
    // Engine::Data::Accessor<TestType, false, false> D; //-> error
